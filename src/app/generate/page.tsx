        ...
        logos: [
          {
            ...
            image_url: response.data.logo_url ? 
              `${process.env.NEXT_PUBLIC_API_URL}${response.data.logo_url}` : 
              `https://via.placeholder.com/400x400/1e40af/white?text=${encodeURIComponent(response.data.company_name)}`,
